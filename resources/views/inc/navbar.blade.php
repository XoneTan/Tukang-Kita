            ...
            <ul class="nav navbar-nav">
                ...
                <div class="form-inline search" style="margin-top: 7px; margin-left:30px;">
                  <input type="search" class="form-control rounded" placeholder="Cari disini..." aria-label="Search"
                    aria-describedby="search-addon" style="width: 700px;;" id="searchPost"/>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                @else
                    <li class="dropdown">
                        ...
                        <a href="/favorite" style="display: inline; font-size:20px;margin-top:1px;"data-toggle="tooltip" data-placement="top" title="Favourites">⭐️</a>
